...
import corego from "../assets/imagens/corego.jpg"
import flores from "../assets/imagens/flores.jpg"
import hotel from "../assets/imagens/hotel.jpg"
import montanha from "../assets/imagens/montamha.jpg"


// Array de objetos com dados dos pontos turísticos (imagem, título e descrição)
const tourist_places = [
    { Image: corego, title: " Ponte do lago ", description: " Ponto turistico natural" },
    { Image: flores, title: " montanha das flores", description: " Ponto turistico natural" },
    { Image: hotel, title: "Hotel", description: "ponto turistico natural" },
    { Image: montanha, title: "montanha", description: "Ponto turistico natural" },
