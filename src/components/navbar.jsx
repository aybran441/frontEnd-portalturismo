...
const Navbar = () => {
    ...
    return (
        ...
        <nav className="w-full bg-gradient-to-r from-blue-300 to-blue-700 text-gray-800 py-0 px-2 shadow-lg fixed top-0 left-0 z-30">
            ...
            <div className={`lg:hidden bg-gradient-to-r from-blue-300 to-blue-700 p-4 transition-all duration-300 ${isMenuOpen ? 'block' : 'hidden'}`}>
                {menuLinks}
            </div>
        </nav>
    );
